...
def main():
    ...
    # np.savetxt('part2_positive_damping.csv', thetamat, delimiter=',')
    ...
    np.savetxt('part2_large_positive_damping.csv', thetamat, delimiter=',')
    ...
    # np.savetxt('part2_negative_damping.csv', thetamat, delimiter=',')
